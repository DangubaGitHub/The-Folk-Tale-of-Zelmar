...
public class Small_Chest_Bottle_Red : MonoBehaviour
{
    bool isOpen;
    public bool atChest;

    [SerializeField] Transform spawnPoint;
    [SerializeField] GameObject bottle_Red_Chest_Prefab;
    ...
    public void Open_Chest()
    {
        ...
        isOpen = true;
        GameObject item = Instantiate(bottle_Red_Chest_Prefab, spawnPoint.position, Quaternion.identity);
        inventory_Controller_Script.hasBottleRed = true;
        Destroy(item, 1f);
